...
export default function Hero({}: HeroProps) {
  ...
  return (
    <div dir={isRTL ? 'rtl' : 'ltr'} className="relative h-screen overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 left-1/4 w-96 h-96 bg-yellow-600/8 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className={`relative h-full flex flex-col transition-opacity duration-200 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
        {/* Header */}
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div className="relative group">
                  ...
                  >
                    {/* Outer black circle */}
                    <circle cx="50" cy="50" r="48" fill="#000000" stroke="#333333" strokeWidth="2"/>
                    ...
                    {/* Shine effect */}
                    <ellipse cx="35" cy="35" rx="15" ry="20" fill="url(#shine)" opacity="0.3"/>
          ...
          <div className="max-w-6xl mx-auto w-full">
            <div className={`text-center space-y-6 sm:space-y-8 lg:space-y-10 ${isRTL ? 'font-arabic' : ''}`}>
              ...
              <div className="flex justify-center animate-fade-in">
                <div className="group inline-flex items-center gap-2 sm:gap-3 px-5 sm:px-8 md:px-10 py-3 sm:py-3.5 md:py-4 rounded-2xl bg-gradient-to-r from-yellow-500/10 via-yellow-500/15 to-yellow-500/10 border border-yellow-500/30 backdrop-blur-md hover:border-yellow-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-yellow-500/20">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 pt-4 sm:pt-6 lg:pt-8">
                ...
                >
                  <span className="group-hover:text-yellow-400 transition-colors">{t.viewServices}</span>
                </a>
              </div>
            </div>
          </div>
