  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-linear-to-b from-amber-900/30 via-yellow-800/20 to-[#0a0b0f]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-4 flex flex-col items-center justify-center pt-10">
        <div
          className={`text-center flex flex-col items-center ${isRTL ? "font-arabic" : ""}`}
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold tracking-wide mb-3 flex flex-col sm:flex-row sm:flex-wrap justify-center gap-1 sm:gap-3 md:gap-4 drop-shadow-[0_8px_16px_rgba(0,0,0,0.8)]">
            ...
            <span
              ...
              style={{
                filter: "drop-shadow(0px 4px 6px rgba(234, 179, 8, 0.4))",
              }}
            >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center w-full mt-4">
            <a
              ...
              className="group relative inline-flex items-center justify-center gap-2 w-full sm:w-auto bg-linear-to-b from-[#FDE047] via-[#EAB308] to-[#CA8A04] hover:from-[#FEF08A] hover:via-[#FACC15] hover:to-[#D97706] text-black font-bold text-base md:text-lg py-3.5 px-8 md:px-10 rounded-lg shadow-[0_5px_20px_rgba(234,179,8,0.4)] border border-yellow-200/60 transition-all duration-300 active:scale-[0.98]"
            >
              {/* Overlay FIXED */}
              <span className="absolute inset-0 rounded-lg opacity-0 group-hover:opacity-100 bg-white/20 transition-opacity duration-300 pointer-events-none"></span>

              <FaWhatsapp className="w-5 h-5 md:w-6 md:h-6 shrink-0" />
